...
class RetirementController extends Controller
{
    ...
    public function index($id = null)
    {
        try{
            ...
            if($id == null) return view('retirement.index', compact('model'));
            ...
            $section_Result = Section::where('alias','=','retiroRegimen')->select('name','id')->get();
            ...
            return view('retirement.index', compact('model'));
        }
    }
