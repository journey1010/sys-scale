...
class OtherController extends Controller
{
    ...
    public function index($id = null)
    {
        try{
            ...
            if($id == null) return view('other.index', compact('model'));
            ...
            $section_Result = Section::where('alias','=','otros')->select('name','id')->get();
            ...
            return view('other.index', compact('model', 'section_annexes'));

        } catch(\Exception $e){
            return view('other.index', compact('model'));
        }
    }
}
