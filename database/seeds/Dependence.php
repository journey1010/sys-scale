...
class Dependence extends Seeder
{
    ...
    {
        $list = [
          ['name' => 'ADMINISTRACION-GRDFFS', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'ARCHIVO CENTRAL', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'ARCHIVO REGIONAL', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'AREA ADMINISTRATIVA DEL COMITÉ DE SEGURIDAD Y SALUD EN EL TRABAJO', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'AREA DE ARCHIVO TECNICO-CONTABILIDAD', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'AREA DE ASESORIA LEGAL-RR.HH', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'AREA DE CONTABILIDAD PATRIMONIAL-CONTABILIDADAD', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'ÁREA DE CONTROL PRESUPUESTAL - CONTABILIDAD', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'AREA DE CONTROL PREVIO - CONTABILIDAD', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'AREA DE COORDINACION DE DESARROLLO INSTITUCIONAL,ORGANIZACION Y METODOS', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'AREA DE COORDINACION INTERNA - GRCEYT', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'ÁREA DE COORDINACIÓN INTERNA ARCHIVO TÉCNICO - LOGÍSTICA', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'AREA DE COORDINACION INTERNA DE ADMINISTRACION - GRCEYT', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'AREA DE COORDINACION INTERNA DE BIENESTAR SOCIAL - ACIBS - RR.HH', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'AREA DE COORDINACION INTERNA DE CAPACITACION Y ADMINISTRACION DE PERSONAL - ACIAPC-RR.HH', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'AREA DE COORDINACION INTERNA DE DESARROLLO INSTITUCIONAL', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'AREA DE COORDINACION INTERNA DE PLANIFICACION - GRCEYT', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'AREA DE COORDINACIÓN INTERNA DE PROGRAMACIÓN - LOGÍSTICA', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'AREA DE COORDINACION INTERNA DE REGISTRO Y ESCALAFON - ACIRE - RR.HH', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'AREA DE COORDINACION INTERNA DE REMUNERACIONES - ACIREM-RR.HH', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'AREA DE COORDINACION INTERNA DE SIGA - LOGISTICA', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'AREA DE COORDINACION, DISEÑO DE PROCESOS, SIMPLIFICACION ADM. Y DOCUMENTOS DE GESTION', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'AREA DE PRENSA', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'AUTORIDAD PORTUARIA REGIONAL', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'CAFAE', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'CENTRO DE OPERACIONES DE EMERGENCIA REGIONAL - COER', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'COMISION DE AUDITORIA - CONTRALORIA GENERAL DE LA REPUBLICA', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'COMISION DE RECOMENDACIONES', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'COMISIÓN DE TRANSPARENCIA Y ACCESO A LA INFORMACIÓN PUBLICA', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'COMISION ESPECIAL', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'COMISIÓN ESPECIAL DE PROCESOS ADMINISTRATIVOS , DISCIPLINARIO - CEPAD', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'COMISION GOREL-DEVIDA', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'COMISION PERMANENTE PARA PROCESOS DE SELECCION DE CAS', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'COMITE CONTROL INTERNO', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'COMITE DE CARACTER PERMANENTE PARA ELABORACION Y APROBACION DEL LISTADO DE OBLIGACIONES DERIVADAS DE SENTENCIA', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'COMITE DE GOBIERNO Y TRANSFORMACION DIGITAL', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'COMITE DE OBRAS POR IMPUESTOS', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'COMITE DE PROMOCION DE LA INVERSION PRIVADA', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'COMITÉ DE SEGUIMIENTO DE INVERSIONES', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'COMITE DE SELECCION BIENES', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'COMITE DE SELECCION DE EJECUCION DE OBRAS PARA LICITACION PUBLICA', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'COMITE DE SELECCION DE OBRAS', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'COMITE DE SELECCION SERVICIOS', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'COMITE DE TOMA DE INVENTARIO', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'COMITE ESPECIAL DE OBRAS POR IMPUESTOS', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'COMITE ESPECIAL DE OBRAS POR IMPUESTOS - GRAM', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'COMITE REGIONAL DE SEGURIDAD CIUDADANA', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'COMITE TEC. REFINANCIAMIENTO O FRACCIONAMIENTO DE DEUDA', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'COMITE TECNICO DEL PROCEDIMIENTO ABREVIADO - DEFFS', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'CONSEJO DELEGADO', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'CONSEJO REGIONAL DE CIENCIA Y TECNOLOGIA - CORCYTEC.', 'created_at' => Carbon\Carbon::now(), 'updated_at' => Carbon\Carbon::now()],
          ['name' => 'GERENCIA SUB REGIONAL DEL PUTUMAYO - EL ESTRECHO','created_at' => Carbon\Carbon::now(),'updated_at' => Carbon\Carbon::now()],
