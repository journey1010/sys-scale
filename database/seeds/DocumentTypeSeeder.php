...
class DocumentTypeSeeder extends Seeder
{
    ...
    protected $reconocimientoSancionesDisciplinarias = [
        // 8.1. Reconocimientos
        [
    ...
    protected $relacionesLaboralesIndividualesColectivas = [
        [
    ...
    protected $seguridadSaludTrabajoBienestarSocial = [
