...
class CreatePostgraduateInformationTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('postgraduate_information', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('postgraduate_information');
    }
}
