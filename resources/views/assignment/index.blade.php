...
@section('content')
    ...
    <ol class="breadcrumb pull-right">
        ...
        <li class="active">Asignación de incentivos temporales ...</li>
    </ol>
        ...
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">
                    ...
                    Asignación de incentivos temporales, retenciones judiciales y pagos indebidos
                </h4>
            </div>
            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal">
                    <div class="form-group">
                        <div class="col-xs-6">
                            <h4>Listado de asignación de incentivos temporales, retenciones judiciales y pagos indebidos</h4>
                        </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group{{ $errors->has('file_url') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-8">
                                            {{ Form::file('file_url', array('placeholder' => '','class' => 'form-control', 'accept' => 'application/pdf')) }}
                                        </div>
                                        <div class="col-md-offset-3 col-md-8">
