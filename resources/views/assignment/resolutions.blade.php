...
@section('content')
    <ol class="breadcrumb pull-right">
        ...
        <li><a href="{{ route('getAssignments') }}">Asignación de incentivos temporales ...</a></li>
    ...
    <div class="row">
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Asignación de incentivos temporales, retenciones judiciales y pagos indebidos</h4>
            </div>
