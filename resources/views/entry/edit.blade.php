    ...
    <div class="row">
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Edición de Resolucion</h4>
            </div>
            <div class="panel-body">
                {{ Form::model($model, ['route' => 'entriesEditPost', 'class' => 'form-horizontal', 'method' => 'post', 'enctype' => 'multipart/form-data']) }}
                    {{ Form::hidden('id', null, ['class' => '', 'style' => '']) }}
                    {{ Form::hidden('constancyPath', null, ['class' => '', 'style' => '']) }}
