<div id="addVacationModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            {{ Form::open(['route' => 'postCreateVacation', 'class' => 'form-horizontal', 'method' => 'post', 'enctype' => 'multipart/form-data']) }}
...
{{--                        {!! Form::select('memorando_type', $resolution_types, null, ['class' => 'form-control','required'=>'required']) !!}--}}
                ...
                <div class="form-group{{ $errors->has('suspension_type') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-8">
                        {!! Form::select('suspension_type', config('constants.vacation_suspension_document_type'), null, ['class' => 'form-control','required'=>'required']) !!}
                    </div>
                    <div class="col-md-offset-3 col-md-8">
