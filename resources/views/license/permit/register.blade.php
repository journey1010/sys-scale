<div id="addPermitModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            {{ Form::open(['route' => 'postCreatePermit', 'class' => 'form-horizontal', 'method' => 'post', 'enctype' => 'multipart/form-data']) }}
            ...
            <div class="modal-body">
                ...
                <div class="form-group{{ $errors->has('issue_date') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-8">
                        {{ Form::text('issue_date', null, ['class' => 'form-control', 'id' => 'issue_date3','autocomplete' => 'off']) }}
                    </div>
                    <div class="col-md-offset-3 col-md-8">
...
{{--                        {!! Form::select('memorando_type', $resolution_types, null, ['class' => 'form-control','required'=>'required']) !!}--}}
                ...
                <div class="form-group{{ $errors->has('start_date') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-8">
                        {{ Form::text('start_date', null, ['class' => 'form-control', 'id' => 'start_date3','autocomplete' => 'off']) }}
                    </div>
                    <div class="col-md-offset-3 col-md-8">
                ...
                <div class="form-group{{ $errors->has('end_date') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-8">
                        {{ Form::text('end_date', null, ['class' => 'form-control', 'id' => 'end_date3','autocomplete' => 'off','disabled' => false]) }}
                    </div>
                    <div class="col-md-offset-3 col-md-8">
