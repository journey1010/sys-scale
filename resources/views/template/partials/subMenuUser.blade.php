<h1 class="page-header">
    <div class="btn-group m-r-5 m-b-5">
        ...
        <ul class="dropdown-menu">
            <li><a href="{{ route('personalIdentificationIndex', Session::get('userId')) }}">Identificación Personal</a></li>
            <li><a href="{{ route('allStudies', Session::get('userId')) }}">Formación Académica</a></li>
