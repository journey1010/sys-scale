            ...
            <div class="panel-body">
                ...
                <div class="table-responsive">
                        <table id="data-table" class="table table-striped table-bordered">
                            ...
                            <tr>
                                <td>Copia legalizada de título de nacionalizada</td>
                            ...
                            <tr>
                                <td>Certificado de haber adquirido la nacionalidad por matrimonio</td>
                            ...
                            <tr>
                                <td>Resolución de Discapacidad emitida por CONADIS</td>
                            ...
                            <tr>
                                <td>Copia legalizada de DNI ó Carnet de Extranjería</td>
                            ...
                            {{--<tr>
                                <td>Copia de la partida de nacimiento o DNI de los hijos</td>
                                @if(is_null($Afill->birth_certificate))
                                    <th><label class="label label-danger">NO ADJUNTO </label></th>
                                    <td>{{ Form::file('birth_certificate', array('placeholder' => '','class' => 'form-control-file', 'accept' => '*')) }}</td>
                                @else
