...
@section('content')
    ...
    <ol class="breadcrumb pull-right">
        ...
        <li class="active">Gestión de Dependencia / Facultad</li>
    </ol>
    <h1 class="page-header">Gestión de Dependencia / Facultad<small></small></h1>
    ...
    <div class="row">
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Listado de Dependencias / Facultades</h4>
            </div>
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <table id="table_dependence" class="table table-striped table-bordered" style="margin-bottom: 300px">
                        <thead>
                        <tr>
    ...
    <div id="myModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                {{ Form::open(['route' => 'savedependence', 'class' => 'form-horizontal', 'method' => 'post']) }}
    ...
    <div id="myModal2" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                {{ Form::open(['route' => 'updatedependence', 'class' => 'form-horizontal', 'method' => 'post']) }}
...
@section('scripts')
    <script>
        ...
        $('#table_dependence').on("click", ".editar", function() {
            this.blur();
            var button = $(this);
        ...
        $('#table_dependence').on("click", ".eliminar", function() {
            this.blur();
            var button = $(this);
            var name = button.data('name');
            var id = $(this).val();
            ...
            swal({
                ...
                var url = '{{ url('depcon/deletedependence') }}';
