...
@section('content')
    ...
    <h1 class="page-header">Educación Secundaria<small> &nbsp; {{ empty($model->id) ? "Añadir" : "Editar"  }}</small></h1>
    ...
    <div class="row">
        <div class="panel panel-inverse">
            ...
            <div class="panel-body">
                {{ Form::model($model, ['route' => 'postSecondaryEducation', 'class' => 'form-horizontal', 'method' => 'post', 'enctype' => 'multipart/form-data']) }}
