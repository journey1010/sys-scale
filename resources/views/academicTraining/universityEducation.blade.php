...
@section('content')
    ...
    <h1 class="page-header">Educación Superior<small> &nbsp; Información</small></h1>
        ...
        <div class="panel panel-inverse">
            ...
            <div class="panel-body">
                @if($objUniversityEducation == null)
                    {{ Form::model($objUniversityEducation, ['class' => 'form-horizontal']) }}
                ...
                @else
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{ Form::text('university', null, ['class' => 'form-control', 'disabled' => '', 'style' => 'cursor:default']) }}
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            @if( $objUniversityEducation->url == null || $objUniversityEducation->url == '')
                                {{ Form::label('No presenta', null, ['class' => 'control-label','style' => 'font-weight:100;padding-left:8px']) }}
                            @else
                                <a href="{{ $objUniversityEducation->url }}" class="btn btn-default btn-sm" download><i class="fa fa-download"></i> &nbsp; Descargar</a>
                            @endif
                        </div>
                    </div>
                    {{--<div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{ Form::label('', $objUniversityEducation->state, ['class' => 'control-label','style' => 'font-weight:100;padding-left:8px']) }}
                        </div>
                    </div>--}}
                    ...
                    @if(Auth::user()->hasRole('admin'))
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <a href="{{ route('saveUniversityEducation', $objUniversityEducation->id_user, $objUniversityEducation->id ) }}" class="btn btn-primary">Editar</a>
                            </div>
                        </div>
                    @endif
                    {!! Form::close() !!}
