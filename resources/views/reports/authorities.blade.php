...
@section('content')
    ...
    <h1 class="page-header">Reporte de Autoridades <small></small></h1>
                ...
                <div class="table-responsive">
                    <table id="data-table" class="table table-striped table-bordered">
                        ...
                        <tr>
                            ...
                            <th>Documento que autoriza su nombramiento</th>
                        </tr>
                        </thead>
                        <tbody>
                        @foreach($authorities as $item)
                            <tr>
                                ...
                                <td>{{ date('d/m/Y', strtotime($item->fecha_cese)) }}</td>
                                <td>{{ $item->condition }}</td>
                                <td>{{ "R.R.N° " . $item->resolution_number . " (" . $item->issue_date . ")" }}</td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
