...
@section('content')
    ...
    <h1 class="page-header">Reportes de Resoluciones <small></small></h1>
    ...
    <div class="row">
        <div class="panel panel-inverse">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-6">
                        <h4>Nro. de Resoluciones por Tipo de Resoluci&oacute;n</h4>
                        <div class="table-responsive">
                            <table id="data-table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                @foreach($type_resolution as $item)
                                    <tr>
                                        <td>{{ $item->name }}</td>
                    ...
                    <div class="col-md-6">
                        <h4>Nro. de Tipos de Resoluci&oacute;n por Secci&oacute;n</h4>
                        <div class="table-responsive">
                    ...
                    <div class="col-md-12">
                        <h4>Nro. de Resoluciones por Usuario</h4>
                        <div class="table-responsive">
                            <table id="data-table3" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                @foreach($user_resolution as $item)
                                    <tr>
                                        <td>{{ $item->name }}</td>
                                        <td class="text-center">
                                            {{ $item->total }}
